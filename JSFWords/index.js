...
function playLourabble() {
    ...
    var sRGB = android.graphics.ColorSpace.get(android.graphics.ColorSpace.Named.SRGB)
    var background;
    ...
    function drawCellBackground(row, col, width, height, canvas, paint) {
    	...
    	paint.setColor(Color.pack(Color.GREEN));
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(5);
        canvas.drawRect(width*col, height*row, width*(col+1), height*(row + 1), paint);
        paint.setStyle(Paint.Style.FILL);
        switch (cell(row, col).v) {
        	case DL : paint.setColor(Color.pack(Color.CYAN));break;
        	case TL : paint.setColor(Color.pack(Color.BLUE));break;
        	case DW : paint.setColor(Color.pack(Color.MAGENTA));break;
        	case TW : paint.setColor(Color.pack(Color.RED));break;
        	case OK : paint.setColor(Color.pack(Color.argb(255, 127, 127, 127)));break;
