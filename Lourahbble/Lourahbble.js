...
(function () {
    ...
    const    L2={ color: _p(android.graphics.Color.CYAN) }
    ,L3={ color: _p(android.graphics.Color.BLUE) }
    ,W2={ color: _p(android.graphics.Color.MAGENTA) }
    ,W3={ color: _p(android.graphics.Color.RED) }
    ,__={ color: _p(android.graphics.Color.parseColor("#ffeeeee0")) }
    ;
    ...
    const backgroundColor = _p(android.graphics.Color.parseColor("#ff00af00"));
    ...
    Lourahbble.board.dock = new (function() {
        ...
        this.paint = (pane) => {
          pane.getCanvas().drawColor(__.color);//_p(android.graphics.Color.parseColor("#ff000000")));
          pane.flush();
          }
        this.paintShadow = (pane) => {
          pane.getCanvas().drawColor(_p(android.graphics. Color.LTGRAY));
          pane.flush();
          }
    ...
    var letterBackgroundColor = _p(android.graphics.Color.parseColor("#7ffffff0"));
    var letterShadowBackgroundColor = _p(android.graphics.Color.parseColor("#7f7f7f70"));
